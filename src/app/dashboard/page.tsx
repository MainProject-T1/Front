                ...
                {latestResults.map(result => (
                  <div key={result.id} className="flex items-center gap-md">
                    ...
                    <div className="flex-grow">
                      <p className="font-semibold text-gray-700">{result.diseaseName}</p>
                      <p className="text-xs text-gray-500">{formatDateTime(result.diagnosisDate)}</p>
                    </div>
                  </div>
                ))}
              </div>
