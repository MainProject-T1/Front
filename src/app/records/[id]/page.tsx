...
const RecordDetailPage = () => {
  ...
  const { results, deleteDiagnosisResult } = useDiagnosisStore();
      ...
      <div className="page-container" style={{ paddingBottom: '100px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-xl)', overflowY: 'auto', flex: 1 }}>
          ...
          <div className="card animate-fade-in" style={{ animationDelay: '0.1s' }}>
            <div className="card-header"><h3 className="card-title">진단 설명</h3></div>
          ...
          <div className="card animate-fade-in" style={{ animationDelay: '0.2s' }}>
            <div className="card-header"><h3 className="card-title">상세 정보</h3></div>
          ...
          <div className="card animate-fade-in" style={{ animationDelay: '0.3s' }}>
            <div className="card-header"><h3 className="card-title">권장사항</h3></div>
