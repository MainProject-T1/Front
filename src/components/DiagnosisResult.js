...
const DiagnosisResult = ({ diagnosis, onClose, onConfirm, capturedImage }) => {
  ...
  return (
    <div className="w-full h-full bg-black bg-opacity-50 flex items-stretch justify-center z-50">
      <div className="bg-white rounded-2xl max-w-md w-full h-full overflow-y-auto">
        {/* 헤더 */}
